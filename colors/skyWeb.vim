...
" skyWeb, my white, clean Vim colorscheme made for CSS, HTML and PHP and increasingly more for javascript. Only for gui for the moment and only tested in MacVim 7.3.
" 
" Among other features:
" 
" HTML tag, class and id colors match the CSS tag, class and id colors for easy recognition.
" When you have HTML embedded in PHP I wanted the colors to clearly show the difference between languages. This also goes for other embedded languages (I'm implementing as I stumble upon them).
" Comfortable editing when swithching between applications.
"
" I have tried to find good colorschemes with a white background forever. The colorschemes pyte, google and MacVim's default scheme, macvim, are the best ones I have seen, but there is always something. If this scheme doesn't quite suite your needs I suggest trying one of those.
" 
...
hi phpType guifg=#46587E gui=none
...
hi phpFunctions guifg=#46587E gui=bold
...
hi phpMethodsVar guifg=#0F4D92 gui=none

" ultramarine #120A8F:
hi helpHyperTextJump guifg=#120A8F gui=underline

hi Statement guifg=#120A8F gui=bold
hi! link phpFCKeyword Statement
hi! link phpStatement Statement
hi! link phpSpecial Statement
hi! link vimHighlight Statement

" midnight blue:
hi phpBoolean guifg=#191970 gui=none

hi phpRegion guifg=#191970 gui=none

hi Functions guifg=#191970 gui=bold
...
hi! link htmlTagN htmlStatement

" carmine #960018:
hi htmlString guifg=#960018
hi! link cssClass htmlString
hi! link cssIdentifier htmlString
hi! link htmlValue htmlString

hi String guifg=#92000A
hi phpStringSingle guifg=#92000A
hi! link phpStringDouble String


" venetian red:
hi htmlArg guifg=#C80815
...
hi Special guifg=#40404F gui=none
...
hi vimCommentTitle guifg=#2F4F4F gui=italic
...
" black:
hi StatusLine guifg=#303030 guibg=#B2BEB5 gui=none
hi! link Pmenu StatusLine

hi PmenuSel guifg=#303030 guibg=#E5E4E2 gui=none
...
hi! link javaScriptBoolean			Normal
hi! link javaScriptBracket			Normal
hi! link javaScriptParen			Normal
hi! link javaScriptParenParent	Normal
hi! link vimParenSep					Normal
hi! link SpecialKey Normal

hi htmlSpecialChar guifg=#303030 gui=italic
