...
" Functions
syn match cUserFunction "\v(^\s*\#\s*define\s*)@<!<\h\w*>(\s|\n)*\("me=e-1 contains=cType,cDelimiter,cDefine
syn match cUserFunctionPointer "(\s*\*\s*\h\w*\s*)\(\s\|\n\)*(" contains=cDelimiter,cOperator
syn match cUserMacrosWithParams "\v(^\s*\#\s*define\s*)@<=[A-Za-z0-9_]+\("me=e-1 contains=cType,cDelimiter,cDefine

hi def link cUserFunction cFunction
hi def link cUserFunctionPointer cFunction
hi def link cUserMacrosWithParams Special
